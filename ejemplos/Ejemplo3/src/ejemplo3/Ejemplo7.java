...
public class Ejemplo7 {
    ...
    public static void main(String[] args) {
        ...
        double promedio = 2;
        if (promedio > 10) {
            System.out.printf("Las nota %.2f esta fuera de rango ",
                    promedio);
        } else {
            if (promedio >= 7.5) {
                    ...
                    if ((promedio >= 3) && (promedio < 5)) {
                        ...
                        if ((promedio < 3)) {
                            ...
                            if ((promedio >= 0) && (promedio < 3)) {
                                ...
                                if (promedio < 0) {
                                    System.out.printf("Si la nota  %.2f esta fuera "
                                            + "de rango y es negativa", promedio);
                                } else {
                                    System.out.printf("Si la nota  %.2f esta fuera "
                                            + "de rango y es positiva", promedio);
                                }
                            }
